...
ghq_reg <- lm(ghq12_sum ~ sample + tenure + age + gender_binary + ethnicity_dich + children + partnered + climate1_mean + climate2_mean + climate3_mean + 
  brs_score + fsozuk6, data = df_all)
...
gad_reg <- lm(gad ~ sample + tenure + age + gender_binary + ethnicity_dich + children + partnered + climate1_mean + climate2_mean + climate3_mean + 
  brs_score + fsozuk6, data = df_all)
...
mhlq_reg <- lm(mhlq_mean ~ sample + tenure + age + gender_binary + ethnicity_dich + children + partnered + climate1_mean + climate2_mean + climate3_mean + 
  brs_score + fsozuk6, data = df_all)
...
mhsas_reg <- lm(mhsas ~ sample + tenure + age + gender_binary + ethnicity_dich + children + partnered + climate1_mean + climate2_mean + climate3_mean + 
  brs_score + fsozuk6, data = df_all)
